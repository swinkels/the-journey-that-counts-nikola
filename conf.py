...
BLOG_DESCRIPTION = "About a journey as a software developer..."
...
# DEPLOY_COMMANDS = []
DEPLOY_COMMANDS = ["rsync -Cavz output/ pieter@blog.journeythatcounts.nl:websites/blog-journey-that-counts/"]
