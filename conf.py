...
BLOG_AUTHOR = "Pieter Swinkels"  # (translatable)
BLOG_TITLE = "The journey that counts"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://blog.journeythatcounts.nl/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "swinkels.pieter@yahoo.com"
BLOG_DESCRIPTION = "About a journey as a software developer..."  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -Cavz output/ pieter@blog.journeythatcounts.nl:websites/blog-journey-that-counts/"
    ]
}
